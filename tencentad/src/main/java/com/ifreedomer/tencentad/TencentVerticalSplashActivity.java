 ...
 */
public class TencentVerticalSplashActivity extends BaseADSplashActivity implements SplashADListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tencent_splash);
        container = (ViewGroup) this.findViewById(R.id.tencent_splash_container);
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            fetchSplashAD(this, container, skipView, getAppId(), getSplashId(), this, 0);
        }
    }
    ...
    private void startMainActivity() {
        this.startActivity(new Intent(this, BaseADSplashActivity.sTargetClass));
        this.finish();
    }
